...
| 3 | [第 3 课：中间件管道——顺序、短路与 OWIN 的血缘](https://JayYa.github.io/LearningLessons/ASP.NET%20Core/lessons/0003-middleware-pipeline.html) | 讲清中间件的注册顺序如何决定执行顺序、短路与终结中间件的行为，并追溯到 OWIN 的管道设计渊源 |
...
- [中间件管道速查表](https://JayYa.github.io/LearningLessons/ASP.NET%20Core/reference/middleware-quick-reference.html) — Use/Run/Map 写法、内置中间件推荐顺序与自定义中间件模板速查
...
| 14 | [Lesson 14 · 「慢」是症状，不是问题](https://JayYa.github.io/LearningLessons/BeiGene/lessons/0014-slow-request-triage-and-observability.html) | 把「接口慢」当症状而非结论，用日志、指标与分布式追踪逐层定位慢请求的真正根因 |
...
- [速查表 · 慢请求排查与可观测性](https://JayYa.github.io/LearningLessons/BeiGene/reference/observability-cheatsheet.html) — 慢请求排查步骤、日志/指标/追踪三支柱与 .NET 可观测性工具速查
